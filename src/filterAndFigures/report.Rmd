...
#
#popStatsSub[-1]<-round(popStatsSub[-1],digit=2) 
#tableList<-list()
#tableList[[1]]<-datatable(popStats[popStats$max_missing==max_missing&popStats$maf==maf,])
#
#print(htmltools::tagList(lapply(tableList,print)))
#}
}
```

...
indCoverage<-read.table(paste0(params$args[1],"filters/missingIndvs.imiss"),h=T,sep="\t")
...
popMapFilter<-read.table(paste0(params$args[1],"/stacksFiles/popmapFiltered.tsv"),sep="\t")
numberOfIndividuals<-nrow(popMapFilter)
popmap<-read.table(paste0(params$args[1],"/stacksFiles/popmap.tsv"),sep="\t")
...
treeSegments<-read.table(paste0(params$args[1],"filters/treeSegmentsAll.tsv"),h=T,sep="\t")
treeLabels<-read.table(paste0(params$args[1],"filters/treeLabelsAll.tsv"),h=T,sep="\t")
popStats<-read.table(paste0(params$args[1],"filters/popStatsAll.tsv"),h=T,sep="\t")
fstStats<-read.table(paste0(params$args[1],"filters/fstStatsAll.tsv"),h=T,sep="\t")
